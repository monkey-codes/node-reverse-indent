...
A simple node script to [recursively reverse indent (source) files](https://johanzietsman.com/how-to-reverse-indent-files-with-rxjs/) in a directory.  Ideal for pull requests on **April Fools' Day**.
